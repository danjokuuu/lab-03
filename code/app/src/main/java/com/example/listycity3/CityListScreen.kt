    ...
    Column(modifier = modifier.fillMaxSize()) {
        Row(
            ...
            FloatingActionButton(
                ...
                onClick = {
                    if (selectedCity != null) { showAddCityFields = true }
                    else { showAddCityFields = !showAddCityFields }
                ...
                Button(
                    ...
                    onClick = {
                        if (newCityName.isNotBlank() && newProvinceName.isNotBlank()) {
                            ...
                            if (oldCity == null) { onAddCity(updatedCity) }
                            else { onEditCity(oldCity, updatedCity) }
